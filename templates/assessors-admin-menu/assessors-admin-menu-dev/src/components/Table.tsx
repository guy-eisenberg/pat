...
const Table: React.FC<TableProps> = ({
  ...
  return (
    <table
      {...rest}
      className={c(
        'overflow-hidden rounded-md text-xs text-theme-dark-gray outline outline-1 outline-theme-light-gray',
        rest.className
      )}
    >
      <thead>
        <tr className="border-b border-b-theme-light-gray bg-white">
      ...
      <tbody>
        {data.map((item, i) => (
          <tr
            key={i}
            className="border-theme-light-goutline-theme-light-gray border-b bg-white transition last:border-none"
          >
